...
public class Register {
    ...
    public void cadastrarFuncionarioAdvogado() {
        ...
        System.out.println("===========================================================================");
        System.out.println("+   Cadastrar Advogado - preencha os campos abaixo                        +\n+                                                                         +");
    ...
    public void cadastrarFuncionarioDentista() {
        ...
        System.out.println("===========================================================================");
        System.out.println("+   Cadastrar Dentista - preencha os campos abaixo                        +\n+                                                                         +");
    ...
    public void cadastrarFuncionarioMedico() {
        ...
        System.out.println("===========================================================================");
        System.out.println("+   Cadastrar Médico - preencha os campos abaixo                          +\n+                                                                         +");
